...
\begin{proof} 
    ...
    \begin{center}
        $\displaystyle \mathrm{A}=\sqrt{s(s-a)(s-b)(s-c)}$
    \end{center}
...
\begin{figure}[hbt!]
    \begin{center}
        \includegraphics[width=70mm]{isofig10}
        \caption{a labelled 6-gon, hexagon, with half a slice}
    \end{center}
\end{figure}\leavevmode
\begin{note}
    We will need to use Heron's formula \textbf{and} the AM-GM inequality.
\end{note}
\newpage
\begin{proof} 
